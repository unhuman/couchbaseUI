...
public class CouchbaseUI implements AboutHandler, QuitHandler {
    ...
    public CouchbaseUI() {
        ...
        comboBoxTTLDurationType.addItemListener(new ItemListener() {
            @Override
            public void itemStateChanged(ItemEvent e) {
                if (e.getStateChange() == ItemEvent.SELECTED) {
                    // either set to zero or wipe out the TTL value
                    textFieldTTLAmount.setText((comboBoxTTLDurationType.getSelectedItem().equals(NO_EXPIRY_STRING))
                            ? "0" : "");
                }
            }
        });
